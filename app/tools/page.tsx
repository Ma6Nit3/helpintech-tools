      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-2xl leading-relaxed text-zinc-700">
            Browse all developer, cybersecurity, networking,
            Linux, and IT utilities available on HelpInTech.
          </p>
        ...
        <div className="mt-14 flex flex-wrap gap-4">
          ...
          {categories.map((category, index) => (
            ...
            <button
              ...
              className={`px-6 py-3 rounded-2xl font-semibold transition duration-200 ${
                selectedCategory === category
                  ? "bg-zinc-950 text-white shadow-lg"
                  : "bg-white/80 border border-zinc-200 text-zinc-700 hover:bg-zinc-100 hover:border-violet-300"
              }`}
            >
